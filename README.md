...
将「我要下歌」(https://xiage.yiwuku.com) 音乐站适配为 MusicFree 插件，支持搜索、在线播放、歌词、最新推荐浏览。
...
| `getTopLists` / `getTopListDetail` | 首页「最新/推荐」列表，支持分页 | ✅ |
...
- 推荐：首页 `/` 及分页 `/page_N.html` 复用 `.sound-item` 解析
